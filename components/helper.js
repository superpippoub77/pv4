...
const windowTemplates = {
    default: {
        headerBg: "linear-gradient(to right, #06b6d4, #2563eb)",
        contentBg: "#ffffff",
        contentColor: "#000000",
        footerBg: "#f9fafb",
...
function createWindow({
    ...
    Object.assign(win.style,{
        ...
        left:`${120+Math.random()*60}px`,
        top:`${120+Math.random()*60}px`,
    ...
    btnMin.addEventListener('click', ()=>{
        ...
        Object.assign(iconDiv.style,{
            ...
            background:headerBg, color:'#fff', display:'flex', alignItems:'center', justifyContent:'center',
            borderRadius:'50%', cursor:'pointer', boxShadow:'0 0 10px rgba(0,0,0,0.3)', zIndex:9990
        });
        iconDiv.textContent='📦'; iconDiv.title=title;
        iconDiv.onclick=()=>{
            win.style.display='flex'; if(overlay) overlay.style.display='flex'; iconDiv.remove();
        };
